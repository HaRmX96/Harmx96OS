...
erase_sub:
	...
	start_msg	db 'HaRmX96OS minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting HaRmX96OS minicom; press a key to return to HaRmX96OS', 13, 10, 0
