	...
	%DEFINE OS_VER '1.2'	; OS version number
	%DEFINE OS_API_VER 18	; API version for programs to check
...
option_screen:
	...
	os_init_msg		db 'Harmx96OS - Version : ',OS_VER, 0
	os_version_msg		db 'Code by HaRmX96', 0

	dialog_string_1		db 'Thanks for trying out Harmx96OS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute HaRmX96OS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of HaRmX96OS, and', 0
